...
class playScreen:
    ...
    def question(self, state, nr = 5):
        self.question = database.download_singlequestion(nr)
        self.A = database.download_singlequestionoptionA(nr)
        self.B = database.download_singlequestionoptionB(nr)
        self.C = database.download_singlequestionoptionC(nr)
        self.answer = database.download_question_answer(nr)
        state.labellist[0][0].text = str(self.question)
        state.labellist[0][0].text = str(self.A)
        state.labellist[0][0].text = str(self.B)
        state.labellist[0][0].text = str(self.C)
