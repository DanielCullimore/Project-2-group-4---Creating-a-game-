...
class Game:
    ...
    def initScreens(self):
        ...
        self.screenList[0][0].addButton("Back", int(self.width /2.75), 600)  # Add buttons to the screen
        self.screenList[0][0].addLabel("First place: {} {}".format(str(scores.Firstname),str(scores.Firstscore)), int(self.width / 2.5), 200, size=20)
        self.screenList[0][0].addLabel("Second place: {} {} ".format(str(scores.Secondname),str(scores.Secondscore)), int(self.width / 2.5), 350, size=20)
        self.screenList[0][0].addLabel("Third place: {} {}".format(str(scores.Thirdname),str(scores.Thirdscore)), int(self.width / 2.5), 500, size=20)
    ...
    def buttonFunctions(self):
        if self.state is self.screenList[0][0]:
            if self.state.buttonList[0]:
                print(database.download_scores())
