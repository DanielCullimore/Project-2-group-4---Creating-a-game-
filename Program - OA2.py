import pygame, Database as db, sys, configparser
from random import *
...
class Game:
    ...
    def initScreens(self):
        ...
        self.screenList[0][0].addButton("Play", int(self.width / 3.75), int(self.height/10*1))  # Add buttons to the screen
        self.screenList[0][0].addButton("Options", int(self.width / 3.75), int(self.height/10*3))
        self.screenList[0][0].addButton("Rules", int(self.width / 3.75), int(self.height/10*5))
        self.screenList[0][0].addButton("Exit", int(self.width / 3.75), int(self.height/10*7))
        ...
        self.screenList[0][2].addButton("Back", int(self.width / 3.75), int(self.height/10*7))

        # Init main screen: Choosing play-mode
        self.screenList.append([])  # Make room for new screen
        self.screenList[1].append(Menu(self.p))
        self.screenList[1][0].addButton("Single Player", int(self.width / 3.75), int(self.height/10))
        self.screenList[1][0].addButton("Back", int(self.width / 3.75), int(self.height/10*3))

        # Init main screen: Single player play-mode settings screen
        self.screenList.append([])  # Make room for new screen
        self.screenList[2].append(Menu(self.p))
        self.screenList[2][0].addButton("Play", int(self.width / 3.75), int(self.height/10*1))
        self.screenList[2][0].addLabel("Players = ", int(self.width / 10), int(self.height/10*3))
        self.screenList[2][0].addPlayerButton("4", int(self.width/6*2), int(self.height/10*3))
...
class playScreen:
    def __init__(self, p):
        ...
        self.playerList = []
        self.actionList = []
        x = QuestionScreen(self.screen, self.p, Player(self.screen, (255, 0, 0), "Test", 500, 500)).run()
        print(x)
        self.board = 0
